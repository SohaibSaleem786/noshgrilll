            ...
            <div className="col-md-12 form-container-category">
              ...
              >
                ...
                <div style={{ fontSize: "14px" }} className="col-4 text-center">
                  <strong>Add Waiter</strong>
                </div>
                <div className="text-end col-4" style={{ marginTop: "-1%" }}>
                  {/* <Link to="/Get_Waiter" className="topBtn">
              ...
              <Form onSubmit={handleFormSubmit}>
                <div className="row ">
                  ...
                  <div className="row">
                    <div className="col-md-3 category-field">Address:</div>
                    <div
                      className="col-md-9 input-category"
                      style={{ display: "flex" }}
                    >
                  ...
                  <div className="row">
                    <div className="col-md-3 category-field">Mobile:</div>
                    <div
