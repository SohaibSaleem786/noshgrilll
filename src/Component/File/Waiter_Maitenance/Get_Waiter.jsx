...
const Get_Waiter = () => {
  ...
  const filteredRows = data.rows.filter(
    (row) =>
      (row.w_id && row.w_id.toLowerCase().includes(searchText.toLowerCase())) ||
      (row.w_name &&
        row.w_name.toLowerCase().includes(searchText.toLowerCase())) ||
      (row.w_status &&
        row.w_status.toLowerCase().includes(searchText.toLowerCase()))
  );
