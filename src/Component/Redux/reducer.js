...
const rawReducer = (
  ...
  switch (action.type) {
    case FETCH_RAWS_REQUEST:
      return { ...state, loading: true, error: null };
    case FETCH_RAWS_SUCCESS:
      console.log("Received data in reducer:", action.payload);
      return { ...state, loading: false, data: action.payload, error: null };
    case FETCH_RAWS_FAILURE:
      return { ...state, loading: false, error: action.payload };
    default:
      return state;
  }
...
const itemmReducer = (
  ...
  switch (action.type) {
    case FETCH_ITEMM_REQUEST:
      return { ...state, loading: true, error: null };
    case FETCH_ITEMM_SUCCESS:
      return { ...state, loading: false, data: action.payload, error: null };
    case FETCH_ITEMM_FAILURE:
      return { ...state, loading: false, error: action.payload };
    default:
      return state;
  }
...
const TakeAwayOrderListReducer = (
  state = { loading: false, data: null, error: null },
  action
) => {
  switch (action.type) {
    case FETCH_TAKEAWAYORDERLIST_REQUEST:
      return { ...state, loading: true, error: null };
    case FETCH_TAKEAWAYORDERLIST_SUCCESS:
      return { ...state, loading: false, data: action.payload, error: null };
    case FETCH_TAKEAWAYORDERLIST_FAILURE:
      return { ...state, loading: false, error: action.payload };
    default:
      return state;
  }
...
const DeliveryOrderListReducer = (
  state = { loading: false, data: null, error: null },
  action
) => {
  switch (action.type) {
...
const rootReducer = combineReducers({
  ...
  takeAwayOrderList: TakeAwayOrderListReducer,
});
