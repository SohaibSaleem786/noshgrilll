...
const CheckoutModal = ({
  ...
  const handleCardClick = (index) => {
    ...
    if (getMOP[index].paydsc === "Credit Account") {
  ...
  function Checkout() {
    const getdiscountamountString =
      typeof getdiscountamount === "string"
        ? getdiscountamount
    ...
    const data = {
      ...
      qty: totalItem,
      discount: getdiscountamountString.split(",").join("") || 0,
    };

    console.log(data);

    axios
      .post(`${apiLinks}/CheckOutWeb.php`, data, {
        headers: {
