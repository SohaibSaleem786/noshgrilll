...
function Login() {
  ...
  function UserLogin(event) {
    ...
    axios
      .post(
        "https://crystalsolutions.com.pk/iqbaltrader/loginweb.php",
        formData,
        {
          headers: {
        ...
        >
          <form onSubmit={UserLogin}>
            ...
            <div
              ...
              style={{ paddingTop: "30px", fontSize: "12px" }}
            >
              <div className="d-flex align-items-center ">
                <img src={crystallogo} alt="Login" style={{ width: "30%" }} />
              ...
              <div className="d-flex align-items-center ">
                <span style={{ fontSize: "12px" }}>
                  +92 4235184078 +92 3044770075 <br /> E-mail:
                  info@crystalsolutions.com.pk
                </span>
                <br />
              </div>
            </div>
